            ...
            <div className={`relative flex min-h-screen w-full flex-col grid-bg bg-opacity-5 transition-all duration-700 ${isAntigravity ? 'pt-6' : ''}`}>
                ...
                <header className="flex items-center justify-between whitespace-nowrap border-b-2 border-solid border-primary px-10 py-4 bg-white/80 backdrop-blur-md sticky top-0 z-50">
                    <div className="flex items-center gap-4 text-primary">
                        ...
                        <h2 className="text-primary text-xl font-black leading-tight tracking-tighter uppercase italic">
                            CROWD Oracle
                        </h2>
                    </div>
                    ...
                    <div className="flex flex-1 justify-end gap-8 items-center">
                        ...
                        <div className="flex gap-3">
                            ...
                            <div className="flex min-w-[140px] cursor-pointer items-center justify-center rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold leading-normal tracking-widest uppercase hover:bg-neon-green hover:text-primary transition-all duration-300 border-2 border-primary group relative">
                                <WalletMultiButton className="!bg-transparent !text-inherit !h-full !w-full !p-0 !text-sm !font-bold !uppercase !italic !shadow-none hover:!bg-transparent absolute inset-0 opacity-0" />
                                <span className="truncate relative z-10 pointer-events-none">Connect Wallet</span>
                                <span className="material-symbols-outlined ml-2 text-sm group-hover:rotate-45 transition-transform relative z-10 pointer-events-none">
                                    bolt
                                </span>
                            </div>
                        </div>
                ...
                <main className="flex-1 px-10 py-8 max-w-[1600px] mx-auto w-full transition-transform duration-500">
                        ...
                        <div className="flex gap-4">
                            <div className="flex flex-col items-center gap-2">
                                <div className="flex h-20 w-24 items-center justify-center rounded-xl bg-primary border-b-4 border-neon-purple">
                                    <p className="text-white text-4xl font-mono font-bold leading-tight glitch-text">
                                        00
                                    </p>
                                </div>
                    ...
                    <div className="grid grid-cols-12 gap-8">
                        ...
                        <div className="col-span-12 lg:col-span-3 space-y-6 floating-card">
                            <div className="p-6 rounded-xl border-2 border-primary bg-white shadow-[8px_8px_0px_0px_#141414]">
                                <div className="flex items-center justify-between mb-4">
                                    ...
                                    <span className="material-symbols-outlined text-primary/40 cursor-pointer hover:text-primary">
                                        info
                                    </span>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <div className="h-4 w-full bg-primary/10 rounded-full overflow-hidden p-1 border border-primary/20">
                                            <div
                                                className="h-full rounded-full bg-gradient-to-r from-neon-purple to-neon-green shadow-[0_0_10px_rgba(176,38,255,0.5)]"
                                                style={{ width: "88%" }}
                                            />
                                        </div>

                                        <p className="text-[10px] text-primary/40 text-center italic">
                                            Migration to Raydium Imminent
                                        </p>
                                    </div>
                            ...
                            <div className="p-4 rounded-xl border-2 border-primary bg-primary text-white">
                                <h4 className="text-[10px] font-black uppercase tracking-[0.2em] mb-3 text-neon-green">
                                    Live Oracle Feed
                                </h4>
                        ...
                        <div className="col-span-12 lg:col-span-6 space-y-8 floating-card-alt">
                            <div className="p-8 rounded-2xl border-4 border-primary bg-white relative overflow-hidden">
                                ...
                                <div className="flex flex-col gap-2 mb-12">
                                    ...
                                    <p className="text-primary/60 font-medium">
                                        Forecast the end-of-round ROI for $PEPE3. Hit the target, sweep the pot.
                                    </p>
                                </div>
                                ...
                                <div className="relative py-12 px-4">
                                    <div className="flex justify-between mb-8">
                                        <div className="text-center">
                                            <p className="text-[10px] font-black uppercase tracking-tighter text-primary/40">
                                                Minimum
                                            </p>
                                        ...
                                        <div className="text-center">
                                            <p className="text-xs font-black uppercase tracking-widest text-primary bg-neon-green px-4 py-1 rounded-full border-2 border-primary italic scale-125">
                                                Your Prediction
                                            </p>
                                            <p className="text-6xl font-black italic mt-4 font-mono leading-none">
                                                15.0<span className="text-2xl">X</span>
                                            </p>
                                        </div>
                                ...
                                <div className="flex gap-4 mt-8">
                                    <div className="flex-1 p-4 rounded-xl bg-primary text-white border-2 border-primary">
                                        <p className="text-[10px] font-black uppercase tracking-widest text-white/60 mb-1 italic">
                                            Win Probability
                                        </p>
                                    ...
                                    <div className="flex-1 p-4 rounded-xl border-2 border-primary">
                                        <p className="text-[10px] font-black uppercase tracking-widest text-primary/60 mb-1 italic">
                                            Est. Payout
                                        </p>
                            ...
                            <div className="flex items-center gap-4 bg-primary p-4 rounded-xl text-white">
                                ...
                                <p className="text-xs font-medium">
                                    Tip: Most Oracles are betting between 8x and 12x for this round based on current bonding
                                    velocity.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="col-span-12 lg:col-span-3 space-y-6 floating-card">
                            <div className="p-6 rounded-xl border-2 border-primary bg-white shadow-[8px_8px_0px_0px_#141414]">
                                ...
                                <div className="mb-6">
                                    <div className="flex rounded-lg border-2 border-primary p-1 bg-primary/5 mb-4">
                                        <button className="flex-1 py-2 text-xs font-black uppercase italic rounded bg-primary text-white">
                                            SOL
                                        </button>
                                        <button className="flex-1 py-2 text-xs font-black uppercase italic rounded text-primary hover:bg-primary/10 transition-colors">
                                            $CROWD
                                        </button>
                                    </div>
                                    ...
                                    <div className="relative mb-4">
                                        <input
                                            className="w-full h-14 bg-white border-2 border-primary rounded-xl px-4 text-xl font-bold font-mono focus:ring-0 focus:border-neon-purple outline-none"
                                            placeholder="0.00"
                                            type="number"
                                        />
                                        <button className="absolute right-4 top-1/2 -translate-y-1/2 text-xs font-black uppercase text-neon-purple hover:underline italic">
                                            Max
                                        </button>
                                    </div>

                                    <div className="grid grid-cols-4 gap-2 mb-6">
                                        <button className="py-2 text-[10px] font-black border border-primary/20 rounded hover:bg-primary hover:text-white transition-colors">
                                            0.1
                                        </button>
                                        <button className="py-2 text-[10px] font-black border border-primary/20 rounded hover:bg-primary hover:text-white transition-colors">
                                            0.5
                            ...
                            <div className="p-6 rounded-xl border-2 border-primary bg-primary/5 border-dashed relative group cursor-pointer hover:bg-primary/10 transition-all">
                                ...
                                <span className="material-symbols-outlined absolute top-4 right-4 text-primary/20 group-hover:text-primary transition-colors">
                                    chevron_right
                                </span>
                            </div>
                        </div>
                    ...
                    <div className="mt-16 border-t-2 border-primary pt-8">
                        <div className="flex items-center gap-6 overflow-hidden whitespace-nowrap">
                            <p className="text-[10px] font-black uppercase italic bg-primary text-neon-green px-3 py-1">
                                Recent Hits
                            </p>

                            <div className="flex gap-12 font-mono text-[11px] font-bold uppercase tracking-widest animate-pulse">
                                <span className="flex items-center gap-2">
                                    <span className="w-2 h-2 rounded-full bg-green-500"></span> User 892x hit 12.0x ROI (+$4,200)
                                </span>
                                <span className="flex items-center gap-2 text-primary/40">●</span>
                                <span className="flex items-center gap-2">
                                    <span className="w-2 h-2 rounded-full bg-green-500"></span> Oracle_King hit 5.5x ROI (+$890)
                                </span>
                                <span className="flex items-center gap-2 text-primary/40">●</span>
                                <span className="flex items-center gap-2">
                                    <span className="w-2 h-2 rounded-full bg-green-500"></span> DegenMaster hit 25.0x ROI (+$12,400)
                                </span>
                                <span className="flex items-center gap-2 text-primary/40">●</span>
                                <span className="flex items-center gap-2">
                                    <span className="w-2 h-2 rounded-full bg-green-500"></span> SolanaWhale hit 2.0x ROI (+$450)
                                </span>
                            </div>
                        </div>
                    </div>
